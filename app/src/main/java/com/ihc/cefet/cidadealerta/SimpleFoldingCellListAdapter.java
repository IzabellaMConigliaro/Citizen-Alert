 ...
 */
public class SimpleFoldingCellListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements RequestListener<StaticMap, GlideDrawable> {
    ...
    public static SimpleFoldingCellListAdapter newInstance(Context context, List<Item> items) {
        SimpleFoldingCellListAdapter pa = new SimpleFoldingCellListAdapter(null);
        pa.setContext(context);
        return new SimpleFoldingCellListAdapter(items);
    }
    ...
    public SimpleFoldingCellListAdapter(List<Item> items){
        this.objects = items;
    }
                ...
                viewHolder.cell_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (viewHolder.google_map_layout.getVisibility() == View.VISIBLE) {
                            ...
                            ((SimpleFoldingCellListAdapter)((BaseActivity) mContext).getAdapter()).registerToggle(position);
                        }
