...
import com.ihc.cefet.cidadealerta.R;
...
public class WelcomeScreenConfiguration {
    ...
    public WelcomeScreenConfiguration(Parameters parameters) {
        ...
        if (mParameters.mSwipeToDismiss) {
            mParameters.addPage(new com.stephentuso.welcome.ui.WelcomeScreenPage(new WelcomeFragmentHolder() {
                @Override
    ...
    public com.stephentuso.welcome.ui.BackgroundColor[] getBackgroundColors() {
    ...
    public com.stephentuso.welcome.ui.WelcomeScreenPageList getPages() {
    ...
    public static class Parameters {
        ...
        private com.stephentuso.welcome.ui.WelcomeScreenPageList mPages = new com.stephentuso.welcome.ui.WelcomeScreenPageList();
        private boolean mCanSkip = true;
        private boolean mBackButtonSkips = true;
        private boolean mBackButtonNavigatesPages = true;
        private com.stephentuso.welcome.ui.BackgroundColor mDefaultBackgroundColor;
        ...
        private void setDefaultBackgroundColor(Context context) {
            ...
            mDefaultBackgroundColor = new com.stephentuso.welcome.ui.BackgroundColor(defaultBackgroundColor, standardBackgroundColor);
        }
        ...
        public void setDefaultBackgroundColor(com.stephentuso.welcome.ui.BackgroundColor color) {
        ...
        public void add(WelcomeFragmentHolder fragmentHolder, @ColorRes int resId) {
            addPage(new com.stephentuso.welcome.ui.WelcomeScreenPage(fragmentHolder, new com.stephentuso.welcome.ui.BackgroundColor(getColor(resId), mDefaultBackgroundColor.value())));
        }
        ...
        public void addPage(com.stephentuso.welcome.ui.WelcomeScreenPage page) {
