...
public class ColorChangingBackgroundView extends View {
    ...
    com.stephentuso.welcome.ui.BackgroundColor[] mColors = new com.stephentuso.welcome.ui.BackgroundColor[0];
    ...
    public void setColors(com.stephentuso.welcome.ui.BackgroundColor[] colors) {
        mColors = colors;
    }
