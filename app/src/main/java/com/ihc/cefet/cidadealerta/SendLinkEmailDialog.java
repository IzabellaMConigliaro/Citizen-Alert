 ...
 */
public class SendLinkEmailDialog extends DialogFragment {
    ...
    public static void show(FragmentManager fragmentManager, Context context) {
        SendLinkEmailDialog dialog = new SendLinkEmailDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = getActivity().getLayoutInflater().inflate(R.layout.dialog_forgot_passoword, container, false);
