 ...
 * object and provides a convenient way to create a {@link WelcomeScreenConfiguration WelcomeScreenConfiguration}.
 */
public class WelcomeScreenBuilder {
     ...
     * @return this WelcomeScreenBuilder object to allow method calls to be chained
     */
    public WelcomeScreenBuilder defaultBackgroundColor(com.stephentuso.welcome.ui.BackgroundColor backgroundColor) {
    ...
    /**
     * @return A {@link WelcomeScreenConfiguration WelcomeScreenConfiguration} with the parameters set on this object
     */
